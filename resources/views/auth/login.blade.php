...
<head>
    ...
    <title>Apis manager, platform management </title>
...
<nav class="navbar navbar-primary navbar-transparent navbar-absolute">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href=" ">Apis Manager </a>
        </div>
...
{{--                                    </div>--}}
                                ...
                                <div class="footer text-center">
                                    <button type="submit" class="btn btn-success btn-simple btn-wd btn-lg">Đăng nhập</button>
                                </div>
                            </div>
                        </form>
                    </div>
